...
use self::markdown_codec::{MarkdownCodec, MarkdownExport};
use self::rich_document::{
...
use self::rich_edit::{RichEditor, RichSelection};
...
fn import_rich_document(document: &EditorDocument) -> RichDocument {
    ...
    .unwrap_or_else(|_| {
        ...
        rich.blocks.push(self::rich_document::RichBlock::imported(
            id,
            String::new(),
            source.to_string(),
            self::rich_document::RichBlockKind::OpaqueMarkdown {
