...
fn button_keyboard_and_mouse_activate_the_same_component() {
    ...
    assert_eq!(
        button.handle_event(
            InputEvent::mouse(MouseKind::Down(MouseButton::Left), 2, 1),
            area
        ),
    ...
    assert_eq!(
        button.handle_event(
            InputEvent::mouse(MouseKind::Up(MouseButton::Left), 2, 1),
            area
        ),
        ComponentEvent::Activated(ComponentId::new("save"))
    );
...
fn list_supports_keyboard_selection_mouse_selection_and_activation() {
    ...
    assert_eq!(
        list.handle_event(
            InputEvent::mouse(MouseKind::Click(MouseButton::Left), 1, 3),
            area
        ),
    ...
    assert_eq!(
        list.handle_event(
            InputEvent::mouse(MouseKind::DoubleClick(MouseButton::Left), 1, 3),
            area
        ),
...
fn text_input_edits_text_and_maps_mouse_clicks_to_cursor_positions() {
    ...
    assert_eq!(
        input.handle_event(
            InputEvent::mouse(MouseKind::Click(MouseButton::Left), 2, 1),
            area
        ),
...
fn dialog_is_modal_and_activates_selected_actions() {
    ...
    assert_eq!(
        dialog.handle_event(
            InputEvent::mouse(MouseKind::Click(MouseButton::Left), 0, 0),
            area
        ),
...
fn tabs_support_keyboard_and_mouse_selection() {
    ...
    assert_eq!(
        tabs.handle_event(
            InputEvent::mouse(MouseKind::Click(MouseButton::Left), 14, 1),
            area
        ),
