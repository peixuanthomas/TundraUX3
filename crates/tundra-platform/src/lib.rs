...
pub use diagnostics::{
    ...
    check_directory_read_write, classify_windows_build, is_windows_terminal_session, run_doctor,
    run_doctor_with,
};
pub use paths::{
...
pub use platform::{
    CapabilityStatus, FileAttributes, Platform, PlatformCapabilities, PlatformError, PlatformKind,
    PowerAction, default_file_attributes, native_platform,
};
