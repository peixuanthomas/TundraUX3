...
pub use bootstrap::render_bootstrap_admin_content;
pub use login::{
...
pub use setup::{
    ...
    setup_appearance_shape_option_areas, setup_custom_color_dialog_area,
    setup_custom_color_input_area, setup_language_list_area, setup_render_context,
