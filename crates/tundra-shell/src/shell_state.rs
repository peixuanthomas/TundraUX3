...
pub struct ShellState {
    ...
    setup_border_shape: tundra_storage::BorderShape,
    setup_theme_color: tundra_storage::BorderColor,
    setup_accent_color: tundra_storage::AccentColor,
    setup_custom_color_target: Option<tundra_ui::SetupCustomColorTarget>,
    setup_custom_color_input: String,
    setup_custom_color_error: Option<String>,
